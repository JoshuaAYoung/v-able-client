export default {
  opportunities: [
    ...
    },
    {
      ...
      description:
        'Reporting to the Director of Events, the Senior Events Manager is responsible for overseeing the promotion and logistical execution of global events. This includes but is not limited to: managing vendors, managing onsite experience design, overseeing A/V production, and managing registration. Additionally this role will provide support for other global, regional, and community events. Successful candidates will have managed and coordinated events for international trade groups in the technology sector.',
      start: 'Today',
      duration: '6 weeks',
      commitment: '10 hours',
      edlevel: 'Masters',
    ...
    },
    {
      ...
      description:
        'The Administrative Assistant is responsible for ensuring smooth office operations and is responsible for administrative functions including data entry, filing, reporting and record keeping systems and providing administrative support to the Division.',
      start: 'Now',
      duration: 'Indefinite',
      commitment: '10 hours',
      edlevel: 'Associates',
