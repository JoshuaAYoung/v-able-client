    ...
    if (this.context.userType === 'volunteer' && TokenService.hasAuthToken()) {
      return (
        <div className='volunteerButton'>
          <a href={`mailto:${contact}?subject=${name}%20-%20See%20enclosed%20Volunteer%20Application&body=Good News!%20${name}%20would%20like%20to%20apply%20to%20volunteer%20for%20the%20${title}%20position%20at%20${name}!%0D%0A%0D%0ASee%20below%20for%20a%20message%20from%20${full_name}:`}
