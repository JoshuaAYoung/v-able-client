...
export default class VolunteerButton extends Component {
  ...
  handleRedirect = (ev) => {
    if (this.context.userType !== 'volunteer' && !TokenService.hasAuthToken()) {
      ev.preventDefault()
      this.props.history.push('/success/redirect')
    }
  }
